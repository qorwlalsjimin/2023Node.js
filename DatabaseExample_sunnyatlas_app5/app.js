 ...
 *    http://localhost:3000/adduser.html
 */
...
function connectDB() {
	// 데이터베이스 연결 정보
	var databaseUrl = 'mongodb+srv://annika0227:s3206@cluster0.ggmvcyk.mongodb.net/myuserdb';
...
function createUserSchema() {
	...
	//password를 virtual 메서드로 정의: MongoDB에 저장되지 않는 가상 속성임.
	//특정 속성을 지정하고 set, get 메서드를 정의함
	UserSchema
		.virtual('password')
	...
	//인증메서드 - 입력된 비밀번호와 비교(true/false 리턴)
	UserSchema.method('authenticate', function (plainText, inSalt, hashed_password) {
		if (inSalt) {
			console.log('authenticate 호출됨: %s -> %s: %s',
				plainText,
...
//=> app5.js(password를 받아서 authenticate 처리하는 부분이 추가되어야 함)
